...
from city_scrapers.spiders.ic_council import IcCouncilSpider

test_response = file_response('files/ic_council.html')
spider = IcCouncilSpider()

freezer = freeze_time('2019-01-11')
freezer.start()
